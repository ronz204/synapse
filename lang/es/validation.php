...
return [
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'El valor indicado para :attribute ha aparecido en una filtración de datos. Por favor elija un :attribute diferente.',
    ],
    ...
    */
    ...
    |
    | Livewire Form Object rules() are keyed by the bare property name (e.g.
    | "programId"), not the "form.xxx" name the error bag uses in Blade — the
    | "form." prefix is only added when Livewire merges errors back into the
    | component. Laravel's default humanizer turns "programId" into
    | "program id" (via Str::snake()), which is grammatically wrong in
    | Spanish and not how these fields read elsewhere in the UI — so every
    | field bound through a Form object needs an explicit entry here, keyed
    | WITHOUT the "form." prefix, or it falls back to that humanized-English
    | shape.
    |
    */

    'attributes' => [
        // Curriculum — StudyPlan (RC-01)
        'programId' => 'programa',
        'name' => 'nombre',
        'implementationYear' => 'año de implementación',
        'classification' => 'clasificación',
        'enrollmentClosingDate' => 'fecha de cierre de matrícula',

        // Curriculum — Course (RC-01)
        'code' => 'código',
        'isService' => 'curso de servicio',
